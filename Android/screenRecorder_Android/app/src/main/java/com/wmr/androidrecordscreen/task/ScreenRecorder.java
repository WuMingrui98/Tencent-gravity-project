...
package com.wmr.androidrecordscreen.task;

import static com.wmr.androidrecordscreen.rtmp.RESFlvData.FLV_RTMP_PACKET_TYPE_VIDEO;
        ...
        while (!mQuit.get()) {
            ...
            switch (index) {
                ...
                case MediaCodec.INFO_OUTPUT_FORMAT_CHANGED:
                    ...
                    break;
                default:
                    LogTools.d("VideoSenderThread,MediaCode,index=" + index);
                    if (startTime == 0) {
