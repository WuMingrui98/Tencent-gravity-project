 ...
 * Signature: (J[BII)I
 */
JNIEXPORT jint JNICALL Java_com_wmr_androidrecordscreen_rtmp_RtmpClient_read (JNIEnv * env, jobject thiz, jlong rtmp, jbyteArray data_, jint offset, jint size) {
