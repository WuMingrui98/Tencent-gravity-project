 ...
 * @return 返回-1表示失败，返回0表示成功
 */
int init_SDL(int screen_w, int screen_h, SDL_Renderer **renderer, SDL_Texture **texture, SDL_Rect *rect);
 ...
 * @param video_index 视频流的索引
 */
void encode(AVCodecContext *enc_ctx, AVFrame *frame, AVPacket *new_packet, AVFormatContext *ofmt_ctx, int64_t start_time, int video_index);
